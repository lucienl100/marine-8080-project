...
public class StaticLightDetection : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        int i = 0;
        Collider[] lights = Physics.OverlapSphere(this.transform.position, 50f, lightLayer);
        ...
        renderer.material.SetFloatArray("_PointLightPositionX", X);
        renderer.material.SetFloatArray("_PointLightPositionY", Y);
        renderer.material.SetFloatArray("_PointLightPositionZ", Z);
    }
